...
"""
edx-helpdesk documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'edx-helpdesk',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/edx-helpdesk",
...
#
# html_title = 'edx-helpdesk v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Edx port of django-helpdesk',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'helpdesk'),
                os.path.join(root_path, 'helpdesk/migrations')])
